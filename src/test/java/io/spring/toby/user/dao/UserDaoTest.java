...
public class UserDaoTest {
    ...
    @Before
    public void setUp() {
        user1 = new User("beanie", "비니", "spring1", Level.BASIC, 1, 0);
        user2 = new User("joy", "조이", "spring2", Level.SILVER, 55, 10);
        user3 = new User("marry", "결혼", "spring3", Level.GOLD, 100, 40);
    }
